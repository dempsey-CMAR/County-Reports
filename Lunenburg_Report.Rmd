...
path <- file.path(paste("Y:/Coastal Monitoring Program/Open Data/", county, "/data/compile", sep = ""))

# import the csv file and export as rds (which is faster to read in)
# comment this out after the first export
# dat <- read_csv(paste(path, "/Lunenburg_20201013.csv", sep = ""))
# saveRDS(dat, file = paste(path, "Lunenburg_20201013.rds", sep = "/"))

dat <- readRDS(paste(path, "/Lunenburg_20201013.rds", sep = "")) 
